...
export const adminNavigation = [
    ...navigation,
    {
        href: '/DeletePhysicalBook',
        name: 'Manage Physical Books',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    {
        href: '/DeleteCollectionAndResource',
        name: 'Manage Collection and Resources',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5">
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8a5 5 0 00-10 0v4a5 5 0 0010 0V8z" />
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 18l2 2m0 0l2 2m-2-2l-2 2m2-2l2-2" />
            </svg>
        ),
    },
];
